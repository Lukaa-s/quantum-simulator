...
from quantumsimulator.gates import H, SQRT_2, CNOT, I, X, Y, Z, TOFFOLI
...
class TestGates:
    ...
    def test_gate_3qubits_on_4qubits_basic(self):
    ...
    def test_gate_3qubits_on_4qubits_controls_not_satisfied(self):
